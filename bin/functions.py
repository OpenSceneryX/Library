	...
	for objectSourcePath, objectFilename in objectSourcePaths:
		...
		for line in objectFileContents:
			...
			if result:
				...
				elif not handleTextures(textureFile, True, textures, sceneryObject, result, parts):
					displayMessage("\n" + objectSourcePath + "\n")
			...
			if result:
				textureFound = textureFound + 1
				textureFile = os.path.abspath(os.path.join(dirpath, result.group(1)))
				if not handleTextures(textureFile, False, textures, sceneryObject, result, parts):
					displayMessage("\n" + objectSourcePath + "\n")
...
def handleTextures(textureFile, createFolders, textures, sceneryObject, result, parts):
