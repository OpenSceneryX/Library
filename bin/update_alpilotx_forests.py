...
try:
	...
	try:
		...
		for line in mappingFileContents:
			...
			file.write("URL: https://www.alpilotx.de/\n")
			file.write("Author, texture: Albert Laubi\n")
			file.write("Author, texture: Sergio Santagada\n")
			file.write("Revision: $Revision$\n")
			file.write("Date: $Date$\n")
			file.write("=====================\n")
			file.write("Description: A forest of trees.  See <a href='https://www.alpilotx.de/mambo/index.php?option=com_content&task=view&id=34&Itemid=43' onclick='window.open(this.href);return false;'>this page</a> for documentation containing a map of the " + continentTitle + " areas.\n")
			file.close()
